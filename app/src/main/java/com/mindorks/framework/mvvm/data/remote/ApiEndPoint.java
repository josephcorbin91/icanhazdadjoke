...
public final class ApiEndPoint {
    ...
    public static final String ENDPOINT_DAD_JOKES = BuildConfig.BASIC_URL+"search?term=technology";
    public static final String ENDPOINT_SEARCH_JOKES = BuildConfig.BASIC_URL;
